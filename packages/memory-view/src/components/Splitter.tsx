...
// @loomcycle/explorer carry the same component); the memory-view package
// deliberately owns its own copy rather than sharing, so it has no cross-package
// coupling.
...
export interface SplitterProps {
  ...
  storageKey?: string;
  // Extra class on the outer wrapper (the parent .memory-view rules
