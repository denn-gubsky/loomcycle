  ...
  "properties": {
    ...
    "overlay": {
      ...
      "properties": {
        ...
        "body":        {"type": "object", "properties": {"kind": {"type": "string", "enum": ["code-js","http"]}, "code": {"type": "string", "description": "code-js: a script defining function hook(ev) that returns the decision."}, "url": {"type": "string", "description": "http: the webhook URL."}}, "required": ["kind"], "additionalProperties": false},
