...
const (
	...
	Loomcycle_CreateConfiguredRun_FullMethodName = "/loomcycle.v1.Loomcycle/CreateConfiguredRun"
	Loomcycle_UpdateConfiguredRun_FullMethodName = "/loomcycle.v1.Loomcycle/UpdateConfiguredRun"
	Loomcycle_StartConfiguredRun_FullMethodName  = "/loomcycle.v1.Loomcycle/StartConfiguredRun"
	Loomcycle_DeleteConfiguredRun_FullMethodName = "/loomcycle.v1.Loomcycle/DeleteConfiguredRun"
...
type LoomcycleClient interface {
	...
	CreateConfiguredRun(ctx context.Context, in *RunRequest, opts ...grpc.CallOption) (*ConfiguredRun, error)
	...
	UpdateConfiguredRun(ctx context.Context, in *UpdateConfiguredRunRequest, opts ...grpc.CallOption) (*ConfiguredRun, error)
	...
	StartConfiguredRun(ctx context.Context, in *StartConfiguredRunRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Event], error)
	// DeleteConfiguredRun discards the draft and its session. A live run is
	// FailedPrecondition — cancel it instead.
	DeleteConfiguredRun(ctx context.Context, in *DeleteConfiguredRunRequest, opts ...grpc.CallOption) (*DeleteConfiguredRunResponse, error)
...
func (c *loomcycleClient) CreateConfiguredRun(ctx context.Context, in *RunRequest, opts ...grpc.CallOption) (*ConfiguredRun, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConfiguredRun)
	err := c.cc.Invoke(ctx, Loomcycle_CreateConfiguredRun_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loomcycleClient) UpdateConfiguredRun(ctx context.Context, in *UpdateConfiguredRunRequest, opts ...grpc.CallOption) (*ConfiguredRun, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConfiguredRun)
	err := c.cc.Invoke(ctx, Loomcycle_UpdateConfiguredRun_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loomcycleClient) StartConfiguredRun(ctx context.Context, in *StartConfiguredRunRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Event], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Loomcycle_ServiceDesc.Streams[2], Loomcycle_StartConfiguredRun_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[StartConfiguredRunRequest, Event]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Loomcycle_StartConfiguredRunClient = grpc.ServerStreamingClient[Event]

func (c *loomcycleClient) DeleteConfiguredRun(ctx context.Context, in *DeleteConfiguredRunRequest, opts ...grpc.CallOption) (*DeleteConfiguredRunResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteConfiguredRunResponse)
	err := c.cc.Invoke(ctx, Loomcycle_DeleteConfiguredRun_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loomcycleClient) StreamRun(ctx context.Context, in *StreamRunRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Event], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Loomcycle_ServiceDesc.Streams[3], Loomcycle_StreamRun_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *loomcycleClient) StreamUserRunStates(ctx context.Context, in *StreamUserRunStatesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RunStateEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Loomcycle_ServiceDesc.Streams[4], Loomcycle_StreamUserRunStates_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type LoomcycleServer interface {
	...
	// CreateConfiguredRun takes the same RunRequest as Run; user_bearer,
	// user_credentials and session_id are refused (InvalidArgument).
	CreateConfiguredRun(context.Context, *RunRequest) (*ConfiguredRun, error)
	// UpdateConfiguredRun replaces fields of the draft: `patch` is a JSON object
	// in the wire's snake_case keys, where null removes a field. The agent, the
	// identity and secrets cannot be patched. FailedPrecondition once started.
	UpdateConfiguredRun(context.Context, *UpdateConfiguredRunRequest) (*ConfiguredRun, error)
	// StartConfiguredRun starts the draft and streams it exactly as Run does.
	// An admission refusal (ResourceExhausted / Unavailable) ends the call
	// before any event and leaves the draft configured.
	StartConfiguredRun(*StartConfiguredRunRequest, grpc.ServerStreamingServer[Event]) error
	// DeleteConfiguredRun discards the draft and its session. A live run is
	// FailedPrecondition — cancel it instead.
	DeleteConfiguredRun(context.Context, *DeleteConfiguredRunRequest) (*DeleteConfiguredRunResponse, error)
	// ErasureReport enumerates what this deployment holds about one subject, in
	// three tiers separated by what they guarantee. Read-only.
	//
	// The tenant is taken from the caller's credentials and is NOT a field: a
...
func (UnimplementedLoomcycleServer) CreateConfiguredRun(context.Context, *RunRequest) (*ConfiguredRun, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateConfiguredRun not implemented")
}
func (UnimplementedLoomcycleServer) UpdateConfiguredRun(context.Context, *UpdateConfiguredRunRequest) (*ConfiguredRun, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateConfiguredRun not implemented")
}
func (UnimplementedLoomcycleServer) StartConfiguredRun(*StartConfiguredRunRequest, grpc.ServerStreamingServer[Event]) error {
	return status.Error(codes.Unimplemented, "method StartConfiguredRun not implemented")
}
func (UnimplementedLoomcycleServer) DeleteConfiguredRun(context.Context, *DeleteConfiguredRunRequest) (*DeleteConfiguredRunResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteConfiguredRun not implemented")
}
...
func _Loomcycle_CreateConfiguredRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoomcycleServer).CreateConfiguredRun(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Loomcycle_CreateConfiguredRun_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoomcycleServer).CreateConfiguredRun(ctx, req.(*RunRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Loomcycle_UpdateConfiguredRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateConfiguredRunRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoomcycleServer).UpdateConfiguredRun(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Loomcycle_UpdateConfiguredRun_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoomcycleServer).UpdateConfiguredRun(ctx, req.(*UpdateConfiguredRunRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Loomcycle_StartConfiguredRun_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StartConfiguredRunRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(LoomcycleServer).StartConfiguredRun(m, &grpc.GenericServerStream[StartConfiguredRunRequest, Event]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Loomcycle_StartConfiguredRunServer = grpc.ServerStreamingServer[Event]

func _Loomcycle_DeleteConfiguredRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteConfiguredRunRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoomcycleServer).DeleteConfiguredRun(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Loomcycle_DeleteConfiguredRun_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoomcycleServer).DeleteConfiguredRun(ctx, req.(*DeleteConfiguredRunRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Loomcycle_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateConfiguredRun",
			Handler:    _Loomcycle_CreateConfiguredRun_Handler,
		},
		{
			MethodName: "UpdateConfiguredRun",
			Handler:    _Loomcycle_UpdateConfiguredRun_Handler,
		},
		{
			MethodName: "DeleteConfiguredRun",
			Handler:    _Loomcycle_DeleteConfiguredRun_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "StartConfiguredRun",
			Handler:       _Loomcycle_StartConfiguredRun_Handler,
			ServerStreams: true,
		},
		{
