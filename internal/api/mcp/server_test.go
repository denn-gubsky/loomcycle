...
func TestServer_ToolsList_ReturnsFullCatalogue(t *testing.T) {
	...
	if len(result.Tools) != 44 {
		t.Errorf("got %d tools, want 44 (volumedef on top of the spawn_runs + compact_run list)", len(result.Tools))
	}
