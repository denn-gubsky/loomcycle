...
func run(args []string, stdout, stderr io.Writer) error {
	...
	var (
		...
		retrievalDumpTexts = fs.Bool("retrieval-dump-texts", false, "answer axis: also record the retrieved turn BODIES in the dump, so a second decider can be run off the file instead of re-ingesting")
