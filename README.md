...
| **AgentDef + SkillDef + MCPServerDef substrate** — content-addressed by SHA-256, runtime-mutable, push-at-boot from your container image; verify-or-fork across deployments (runtime stdio MCP defs interpolate `${ENV}` at spawn — F39) | v0.8.5 / v0.8.22 / v0.9.x |
